(function () {
     ...
     * @param {Boolean=} md-select-month Default open view is "year" and closes on selecting month with display format as MMM, yyyy.
        ...
        return {
            template: function (tElement, tAttrs) {
                ...
                return calendarButton +
                    ...
                    'md-select-month="{{::ctrl.selectMonth}}"' +
    ...
    DatePickerCtrl.prototype.onExternalChange = function (value) {
        var timezone = this.$mdUtil.getModelOption(this.ngModelCtrl, 'timezone');
        this.date = value;
        // Read mdSelectMonth attribute if this component is acting as a month picker, then display date in MMM, yyyy format
        this.inputElement.value = this.locale.formatDate(value, timezone, this.$attrs.mdSelectMonth);
