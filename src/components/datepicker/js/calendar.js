(function() {
    ...
    CalendarCtrl.prototype.$onInit = function() {
        ...
        this.selectMonth = this._selectMonth || false;
     ...
     * @param {Date} date
     */
    CalendarCtrl.prototype.setNgModelValue = function(date, showMonthYear) {
        ...
        this.ngModelCtrl.$formatters.push(MonthYear);
